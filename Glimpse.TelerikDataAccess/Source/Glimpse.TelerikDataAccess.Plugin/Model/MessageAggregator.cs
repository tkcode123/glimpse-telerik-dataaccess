...
using System.Linq;
using Glimpse.TelerikDataAccess.Plugin;

namespace Glimpse.TelerikDataAccess.Plugin.Model
{
    internal class MessageAggregator
    {
        public MessageAggregator(IList<DataAccessMessage> messages)
        {
            Messages = messages;           
        }

        private IList<DataAccessMessage> Messages { get; set; }

        private MessageAggregation Metadata { get; set; }

        public MessageAggregation Aggregate()
        {
            Metadata = new MessageAggregation();
